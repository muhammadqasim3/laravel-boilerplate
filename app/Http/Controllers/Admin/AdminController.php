...
class AdminController extends Controller
{
	...
	public function contactSubmissionsDelete($id) {
		  ...
		  if($del) { 
			  return redirect('admin/contact/submissions')->with('flash_message', 'Contact deleted!');
		  }
	...
	public function requestSubmissions () {
	 	$request_inquiries = DB::table('request')->get();

	 	return view('admin.inquires.request_inquiry', compact('request_inquiries'));

	}
	public function requestshow($id) {
		
	 	     $request = DB::table('request')->where('id',$id)->first();
            return view('admin.inquires.requestdetail', compact('request'));
    }
	
	public function requestDelete($id) {
		  $del = DB::table('request')->where('id',$id)->delete();
		  
		  if($del) { 
			  return redirect('admin/request/inquiries')->with('flash_message', 'Request deleted!');
		  }
