                                ...
                                <form method="POST" class="form bordered-input" action="{{ route('login') }}">
                                    ...
                                    <div class="p-30 pb-0">
                                        <div class="form-group m-t-20 row">
                                            <div class="col-12">
											<img style="    margin: 0px auto !important;
    display: flex;" src="https://demo-webdesignservices.com/online_mental_health/public/images/logo.png" />
                                                <br><label for="example-search-input"
