                                ...
                                <form method="POST" class="form bordered-input" action="{{ route('password.update') }}">
                                    ...
                                    <div class="p-30 pb-0">
                                        ...
                                        <div class="form-group m-t-20 row">
                                            <div class="col-12">
												<label class="col-form-label font-12 text-primary p-0">{{ __('Email') }}</label>
                                        ...
                                        <div class="form-group row m-b-30">
                                            <div class="col-12">
                                                <label class="col-form-label font-12 text-primary p-0">{{ __('Password') }}</label>
                                                <input class="form-control  pl-0 font-12 {{ $errors->has('password') ? ' is-invalid' : '' }}"  type="password" name="password" placeholder="{{ __('test.password') }}" >
                                        ...
                                        <div class="form-group row m-b-20">
                                            <div class="col-12">
                                                <input id="password-confirm" type="password" class="form-control  pl-0 font-12" name="password_confirmation"  placeholder="{{ __('test.confirmpassword') }}" >
                                            </div>
                                        ...
                                        <div class="form-group row m-b-10">
                                            <div class="col-12">
                                                <p><button type="submit" class="btn btn-rounded btn-primary m-b-20 btn-block waves-effect waves-light d-block">{{ __('test.resetpassword') }}</button></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
