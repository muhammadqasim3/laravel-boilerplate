                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex m-b-10 no-block">
                            <h5 class="card-title m-b-0 align-self-center">Request Submissions</h5>
                        ...
                        <div class="table-responsive m-t-10">
                            <table id="myTable" class="table color-table table-bordered product-table table-hover">
                                ...
                                <tbody>
								@foreach($request_inquiries as $item)	
									<tr>
									  <td>{{ $item->id }}</td>
										...
										<td class="text-center">
											 ...
											 <a href="{{ url('/admin/request/inquiries/'.$item->id) }}"><i class="fas fa-eye"></i></a>
											 <a href="{{ url('/admin/request/submissions/delete',$item->id) }}" onclick='return confirm("Confirm delete?")'><i class="fas fa-trash-alt text-danger"></i></a>
