                            ...
                            <table id="myTable" class="table color-table table-bordered product-table table-hover">
							 ...
							 @foreach($banner as $item)	
                                <tr>
									...
									<td class="text-center"><a href="{{ url('/admin/banner/' . $item->id . '/edit') }}"><i class="fas fa-pencil-alt"></i></a></td>
									<td class="text-center">
										<a href="{{ route('banner.delete', $item->id) }}" onclick='return confirm("Confirm delete?")'><i class="fas fa-trash-alt text-danger"></i></a>
									</td>
